...
import info.btsland.exchange.model.UserInfoExample.Criteria;
import info.btsland.exchange.model.UserInfoExample.Criterion;
...
public class UserInfoSqlProvider {
    ...
    public String insertSelective(UserInfo record) {
        ...
        if (record.getLevel() != null) {
            VALUES("level", "#{level,jdbcType=DOUBLE}");
        }
